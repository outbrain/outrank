...
from outrank.feature_transformations.feature_transformer_vault.fw_transformers import \
    FW_TRANSFORMERS
from outrank.feature_transformations.feature_transformer_vault.comprehensive_transformers import \
    COMPREHENSIVE_TRANSFORMERS
...
_tr_global_namespace = {
    ...
    'comprehensive' : COMPREHENSIVE_TRANSFORMERS,
}
